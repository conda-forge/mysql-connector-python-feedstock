...
validate_recipe_outputs "mysql-connector-python-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="mysql-connector-python-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi